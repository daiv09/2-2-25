  ...
  return (
    ...
    >
        ...
        >
          {hovered && (
            <>
              ...
              <stop offset="25%" stopColor="#ff4ecd" />
      ...
      <text
        ...
        strokeWidth="0.3"
        className="fill-transparent stroke-[#ff008c] font-[helvetica] text-7xl font-bold dark:stroke-[#ff008c99]"
...
export const FooterBackgroundGradient = () => {
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(125% 125% at 50% 10%, #0F0F1166 50%, #ff008c33 100%)",
      }}
    />
  );
};
