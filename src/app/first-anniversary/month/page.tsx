    ...
    <div>
      ...
      <div className="container mx-auto mt-8 text-center">
        ...
        <p className="mt-6 text-lg text-gray-800">
          A MONTH together, full of memories, laughter, and love. Our first
          anniversary was a day to remember and celebrate all the beautiful
          moments we shared. We used to type very long messages at midnight to
          wish each other the on the 2nd of every month !!
        </p>
        <Link
          href="/"
