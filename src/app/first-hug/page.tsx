    ...
    <div>
      ...
      <div className="container mx-auto mt-8 text-center">
        ...
        <p className="mt-6 text-lg text-gray-800">
          The first hug was more than just a simple embrace; it felt like we
          were home with each other. The warmth and love in that moment was
          unforgettable.
          <br />
          It was when we got our semester results, and we both were happy with
          our grades. We decided to celebrate it with a hug.
          <br />
