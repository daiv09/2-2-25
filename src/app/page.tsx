      ...
      <div className="container mx-auto mt-12 px-4">
        <div className="text-center mt-12">
          ...
          <div className="bg-gradient-to-r from-pink-500 to-red-400 text-white p-6 rounded-3xl shadow-xl max-w-lg mx-auto transform hover:scale-105 transition-all duration-300">
            <h2 className="text-3xl font-semibold mb-4 text-white">Time since 2nd August 2024</h2>
            <div className="flex justify-center items-center space-x-6">
              <div className="text-4xl font-bold bg-white text-pink-500 rounded-lg p-4 shadow-lg">
                {timeSince.days} <span className="text-sm">Days</span>
              </div>
              <div className="text-4xl font-bold bg-white text-pink-500 rounded-lg p-4 shadow-lg">
                {timeSince.hours} <span className="text-sm">Hours</span>
              </div>
              <div className="text-4xl font-bold bg-white text-pink-500 rounded-lg p-4 shadow-lg">
                {timeSince.minutes} <span className="text-sm">Minutes</span>
              </div>
              <div className="text-4xl font-bold bg-white text-pink-500 rounded-lg p-4 shadow-lg">
                {timeSince.seconds} <span className="text-sm">Seconds</span>
              </div>
            </div>
          </div>
        </div>
